...
.section-one {
  ...
  .icons-container {
    ...
    .item {
      ...
      .building-icon {
        background: url('@/asserts/building-icon.png') no-repeat 50% 0 / contain;
      }

      .enterprise-icon {
        background: url('@/asserts/enterprise-icon.png') no-repeat 50% 0 / contain;
      }

      .rod-icon {
        background: url('@/asserts/rod-icon.png') no-repeat 50% 0 / contain;
      }

      .car-icon {
        background: url('@/asserts/car-icon.png') no-repeat 50% 0 / contain;
      }
